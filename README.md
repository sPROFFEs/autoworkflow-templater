...
1. Copia el contenido de esta carpeta al repo nuevo.
2. Ajusta `PROJECT_LANG` en los workflows.
...
4. Verifica `BUILD_CONTRACT.md`.
5. Actualiza `CHANGELOG.md` con `## [1.0.0] - YYYY-MM-DD`.
6. Ejecuta `./publish.sh v1.0.0 "Initial release"`.

## Notas por plataforma
- En GitHub usa `.github/workflows/release.yaml`.
- En Gitea usa `.gitea/workflows/release.yaml`.
- No mezcles acción de release de Gitea en GitHub ni viceversa.
